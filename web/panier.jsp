...
<head>
    ...
    <link href="vendor/dataTables.bootstrap4.min.css" rel="stylesheet" media="all">  
    <script src="vendor/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="vendor/dataTables.bootstrap4.min.js" type="text/javascript"></script>
...
<body>
                    ...
                    <table id="tPanier" class="table table-hover" style="width: 100%;">
                        ...
                        %> 
                            <tr>
                                ...
                                <td><button type="button" class="button-85 supprimer"> <a href="./DeleteCommande?id=<%=  %> ">Supprimer</button></td>
    ...
    <script src="script/panier.js" type="text/javascript"></script>
    <script>
        $(function () {
